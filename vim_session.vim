...
noremap ,l :call LoadCurrentSession()
noremap ,s :call SaveCurrentSession()
nnoremap ,tv :Tab /¦
nnoremap ,te :Tab /=
nnoremap ,tt :Tab /
...
set matchtime=2
set ruler
set runtimepath=~/vimfiles,~\\.vim\\bundle\\Vundle.vim,~\\.vim\\bundle\\powerline\\powerline\\bindings\\vim,~\\.vim\\bundle\\nerdtree,~\\.vim\\bundle\\tabular,~\\.vim\\bundle\\vim-markdown,~\\.vim\\bundle\\gundo.vim,~\\.vim\\bundle\\vim-repeat,~\\.vim\\bundle\\ultisnips,~\\.vim\\bundle\\vim-snippets,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim74,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after,~/.vim/bundle/Vundle.vim/,~\\.vim\\bundle\\Vundle.vim/after,~\\.vim\\bundle\\powerline\\powerline\\bindings\\vim/after,~\\.vim\\bundle\\nerdtree/after,~\\.vim\\bundle\\tabular/after,~\\.vim\\bundle\\vim-markdown/after,~\\.vim\\bundle\\gundo.vim/after,~\\.vim\\bundle\\vim-repeat/after,~\\.vim\\bundle\\ultisnips/after,~\\.vim\\bundle\\vim-snippets/after
set showmatch
set smartindent
set splitbelow
set splitright
...
silent only
cd ~\Dropbox\workspace\PyDataDisplay
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +53 ~\Dropbox\workspace\PyDataDisplay\wx_display.py
badd +31 ~\Dropbox\workspace\PyDataDisplay\bigram_finder.py
badd +0 ~\Dropbox\workspace\PyDataDisplay\display.py
badd +0 ~\Dropbox\workspace\sum-digitsum.py
badd +0 ~\computer_reset.txt
badd +0 ~\Dropbox\computer_reset.txt
silent! argdel *
edit ~\Dropbox\workspace\PyDataDisplay\display.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 102 - ((29 * winheight(0) + 25) / 50)
...
wincmd w
argglobal
edit ~\Dropbox\workspace\sum-digitsum.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
